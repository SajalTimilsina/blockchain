...
?>
	...
	<body>
	    ...
	    <div class="row dropdown col-sm-12 ">
	        <button onclick="myFunction()" class="dropbtn">Select Candidate To View VoteCounts</button>
		...
		<div id="wrap">
			<div id="left">
				...
				<fieldset><legend id => Select a Candidate From the List</legend>
 				<input name="Candidates" list="Candidates">
			...
			<div id="right">
				<div id="top_right">
					<fieldset style="border:#A9A9A9 3px solid;"><legend>Public Key:</legend><a id="public_key">Public Key displays here... </a></fieldset>
				</div>
				<div id="bottom_right">
