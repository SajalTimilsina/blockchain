  ...
  $str_data = json_encode($data1);
    ...
    function sendPostData($url, $post){
     ...
     // ------------------ call function --------------
       ...
       //------------------------------------------------------------
        $url_send3 = $_SESSION["node"].":5001/keys";
        $dataamt3 = ["Account_holder" => get_client_ip()] ;

        $dataamtstr3 = json_encode($dataamt3);
        $amt3 = sendPostData($url_send3,$dataamtstr3);
        $char3 = json_decode($amt3, true);
        if (!empty($char3)) {
        foreach ($char3 as $value => $xvalue) {
         $keyvalue = $xvalue;
         } 
...
?>
	...
	<body>
	    ...
	    <div class="row dropdown col-sm-12 ">
	        <button onclick="myFunction()" class="dropbtn"><?php $char3 ?>Select Candidate To View VoteCounts</button>
	...
	<div class="container">
		...
		<div id="wrap">
			<div id="left">
				...
				<fieldset><legend id => Select a Candidate From the List</legend>
 				<input name="Candidates" list="Candidates" id="candy">
 				<datalist id="Candidates">
    				<option value="Ganeshman singh">
    				<option value="Gagan Thapa">
    				<option value="Sher Bdr Deuba">
    				<option value="K.P.Oli">
    			    <option value="Ramsharan Mahat">
			...
			<div id="right">
				<div id="top_right">
					<fieldset style="border:#A9A9A9 3px solid;"><legend>Public Key:</legend><a id="public_key"><?php echo $keyvalue; ?>Public Key displays here... </a></fieldset>
				</div>
				<!-- <div id="bottom_right">
					<fieldset style="border:#A9A9A9 3px solid;"><legend>Your Private Key:</legend><a id="private_key">Private Key displays here...</a></fieldset>
				</div> -->
		    </div>
		</div>
